object Libs {
    ...
    const val lifecycle_livedata: String = "androidx.lifecycle:lifecycle-livedata-ktx:" +
            Versions.lifecycle
    ...
    const val room_runtime: String = "androidx.room:room-runtime:" +
            Versions.room

    const val room_compiler: String = "androidx.room:room-compiler:" +
            Versions.room

    const val room_ktx: String = "androidx.room:room-ktx:" +
            Versions.room
